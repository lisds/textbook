...
labels](../data-frames/df_basic_cols_indexing).  We called this *direct indexing with column labels* (DICL).


## Simple indexing and the golden rule

We will now use the term *simple indexing* to cover both of DIBS and DICL.
