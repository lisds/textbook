...
The [subexpressions](../code-basics/sub_expressions) page discussed the idea of expressions that get evaluated in the course of evaluating a larger expression.
...
values were greater than 1000, returning a new DataFrame, containing only those rows that have corresponding True values in the Boolean Series.
