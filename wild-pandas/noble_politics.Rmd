...
We start by making the label pair DataFrame.
...
We want to repeat the first row (label 0) of the pairs data frame 64 times, the second (label 1) 7 times, and so on:
...
people = label_pairs.loc[label_indices]
people
```
