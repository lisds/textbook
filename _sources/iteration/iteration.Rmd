...
We know the `integers` method of the `rng` object claims to choose randomly
...
v = 0
tosses[0] = rng.integers(0, 2)
v = 1
tosses[1] = rng.integers(0, 2)
v = 2
tosses[2] = rng.integers(0, 2)
v = 3
tosses[3] = rng.integers(0, 2)
v = 4
tosses[4] = rng.integers(0, 2)
...
`integers` can take a third argument, corresponding to `size`.  This call
...
for i in np.arange(N):
    tosses = rng.integers(0, 2, size=100)
