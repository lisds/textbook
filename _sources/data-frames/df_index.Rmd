...
In this default case, the *label* of the first row is 0, the label of the
...
We have now dropped the rows with label 0, 2 and 4, among others.  The first
row in the data frame (the row at position 0) now has label 1the second row
(position 1) has label 3, and the third has label 5.  The row labels no longer
correspond to the row positions.
...
the Pandas houses the column labels in the `.colums` attribute of the
DataFrame.
...
else give more memorable labels for the rows.
