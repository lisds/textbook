...
There were 774 voters who claimed to have voted "Remain", and therefore, `remain_ages` has 774 values:
...
`remain_ages` is therefore an array length 774, that contains the 774 reported ages for the Remain voters:
...
`leave_ages` is therefore an array length 541, that contains the 541 reported ages for the Leave voters:
