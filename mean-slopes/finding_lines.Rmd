...
```{python}
# The first value is returned array is the slope,
# the second is the RMSE for this slope and intercept.
...
for i in np.arange(n_intercepts):
    ...
    best_slopes[i] = slope_and_error[0]
    lowest_errors[i] = slope_and_error[1]
