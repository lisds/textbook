...
lots_of_0_1 = rng.integers(0, 2, size=10000)
...
Another way of doing this is to use `rng.choice`.

As usual, check the arguments that the function expects with `rng.choice?` in a notebook cell.
